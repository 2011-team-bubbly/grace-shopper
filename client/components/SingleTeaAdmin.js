      ...
      <div>
        <main id="individual-tea">
          <div>
            ...
            <p> size: {singleTeaInReact.size}</p>
        ...
        <div />
        <UpdateTeaForm id={singleTeaInReact.id} />
      </div>
    )
  }
}
...
const connectSingleTeaAdmin = connect(mapStateToProps, mapDispatchToProps)(
  SingleTea
)

export default connectSingleTeaAdmin
